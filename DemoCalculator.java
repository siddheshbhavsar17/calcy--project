...
public class DemoCalculator extends JFrame implements ActionListener {
	...
	private static final long serialVersionUID = -7264648738177428538L;
	JPanel jp1, jp2;
	JTextField jtf;
	JButton[] btns;
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (cap.equals("1"))
			...
			try {
				...
				case "/":
					if (n2 == 0) {
						jtf.setText("Error: Division by zero");
						return;
					}
					result = n1 / n2;
					break;
				default:
					jtf.setText("Error: Invalid operator");
					return;
				}

				// Round the result to an integer and display
				jtf.setText(String.valueOf((int) result));
			} catch (NumberFormatException ex) {
				jtf.setText("Error: Invalid input");
			}
		}
	}
}
